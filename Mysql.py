...
class MySQL():
    ...
    def primary_key(self, nombre_tabla, nombre_columna, num_columna, columna_adicional=False, columnas_generadoras=[]):
        ...
        # caso 2 -> no existen valores duplicados y sin columna adicional
            ...
            # Tiene problemas para trebajar con datos de tipo TEXT/BLOB
            # En consecuencia vamos a cambiar el tipo de la columna
            comando = f'ALTER TABLE {nombre_tabla} MODIFY {nombre_columna} VARCHAR(50);'
            self.ejecutar(comando)
    ...
    def foreign_key(self, tabla1, columna1, tabla2, columna2):
        # Esto es para asegurarnos que estamos trabajando con columnas del mismo tipo
        comando = f'ALTER TABLE {tabla1} MODIFY {columna1} VARCHAR(50);'
        self.ejecutar(comando)
        comando = f'ALTER TABLE {tabla2} MODIFY {columna2} VARCHAR(50);'
        self.ejecutar(comando)
    ...
    def change_datatype(self, nombre_tabla, nombre_columna, tipo):
        ...
        MODIFY COLUMN {nombre_columna} {tipo};'''
        self.ejecutar(comando)
